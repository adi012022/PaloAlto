...
variable "resource_group_name" {
  ...
  type        = string
  default     = "RG-SANDBOX-CB-PALOALTOFW"
}
...
variable "name" {
  ...
  default     = ["VM-01-PAN-INT-CORE-PRD-AUSSE", "VM-02-PAN-INT-CORE-PRD-AUSSE", "VM-01-PAN-EXT-CORE-PRD-AUSSE", "VM-02-PAN-EXT-CORE-PRD-AUSSE"]
  type        = list(string)
}
